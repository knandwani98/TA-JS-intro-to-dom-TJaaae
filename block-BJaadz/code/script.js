...
allHrsArray.map((ele) => ele.style.background = "antiquewhite")
...
document.querySelectorAll("hr[class = image]").forEach((ele) => ele.style.border = "2px solid purple")

// Hide the box number 17 (last box).
let allBox = document.querySelectorAll(".box")
allBox[allBox.length - 1].style.display = "none";
...
document.querySelector(".three").prepend(document.createElement('p').innerText = "Prepend inserts as first child");
...
imgElm.src = 'https://images.unsplash.com/photo-1643952565574-e54e5a460808?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=830&q=80'
