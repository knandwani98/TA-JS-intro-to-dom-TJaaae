...
console.log(document.querySelectorAll('button').length, 'buttons');


// 18. Select all the `label` element and log the count.
console.log(document.querySelectorAll('label').length, 'label');
...
console.log(emailInput,topics,label,inputCheckbox,attrPassword,allTopics,allInput, listOfSelectedTopics,firstLi,allPElement,testId,fieldsetElm);
